...
server.on("request", async (req, res) => {
    ...
    switch(extname) {
        ...
        case ".jpg" : contentType = "img/jpg"; break;
        case ".jpeg" : contentType = "img/jpeg"; break;
        case ".gif" : contentType = "img/gif"; break;
    }
    ...
    try {
        ...
        if(req.url === '/' && req.method === "GET"){
            ...
            content = await fs.readFileSync(path.join(__dirname, "views", "styles", "index.css")
            );
            res.end(content);
            ////////////////////////////////////////////////////
        }else if(
            ...
            // 이미지 확장자일 때는 설정된 경로에서 읽어와 응답
            res.end(content);
        }else if(
            extname.includes("js") && req.method === "GET"){
            content = await fs.readFileSync(filePath);
            res.end(content);
        }

        ////////////////////////////////////////////////////////
        // 주소 표시줄에 요청 localhost:3000/subdir
        ...
        ////////////////////////////////////////////////////////
        // 주소 표시줄에 요청 localhost:3000/users
        ...
        ////////////////////////////////////////////////////////
        // :name 파라미터, params
        // 주소 표시줄에 요청 localhost:3000/name/:name/:phone/:addr
        // 주소 표시줄에 요청 localhost:3000/name/kim
        // 주소 표시줄에 요청 localhost:3000/name/park
        // 주소 표시줄에 요청 localhost:3000/name/you
        ...
        // 주소 표시줄에 DELETE 요청 localhost:3000/name/:name/:phone/:addr
        // 주소 표시줄에 DELETE 요청 localhost:3000/name/kim
        // 주소 표시줄에 DELETE 요청 localhost:3000/name/you
        // 주소 표시줄에 DELETE 요청 localhost:3000/name/park
        ...
        // 요청의 종류 : GET, DELETE, POST, PUT
        // DELETE, POST, PUT 테스트 툴 :  postman, insomnia, thunder client ...
        // 주소 표시줄에 POST 요청 localhost:3000/user
            ...
            req.on("data", (chunk) => {
                ...
                // 추가한 배열을 datas/users.json에 덮어쓰기
                fs.writeFileSync(
                    path.join(__dirname, "datas", "users.json"), 
        ...
        // 요청의 종류 : GET, DELETE, POST, PUT
        // DELETE, POST, PUT 테스트 툴 :  postman, insomnia, thunder client ...
        // 주소 표시줄에 PUT 요청 localhost:3000/user
